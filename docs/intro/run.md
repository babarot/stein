...
To apply the rule to that YAML file and run the test you can do with the [`apply`](../commands/apply.md) subcommand.
...
For more details about this behavior, see also [How policies are loaded by Stein](../configuration/load.md).
