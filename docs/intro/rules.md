...
In such a case, [rule](../configuration/policy/rules.md) block is useful.
...
The available functions are here: [Interpolation Syntax](../configuration/syntax/interpolation.md).
